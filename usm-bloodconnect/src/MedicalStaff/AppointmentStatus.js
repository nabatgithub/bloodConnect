          ...
          <div className={styles.modalDonorForm}>
            <form className={styles.statusForm} onSubmit={handleSave}>
              <div className={styles.formGroup}>
                <h3 className={styles.titleDonorForm}>
                  Donor Appointment Status
                </h3>
              ...
              <div className={styles.formGroup}>
                <label htmlFor="bloodPacket" className={styles.label}>
                  Blood Packet
                </label>
                <input
                  type="number"
              ...
              <div className={styles.buttonContainer1}>
                ...
                >
                  <button className={styles.close1Button} tabIndex={0}>
                    Cancel
                  </button>
                </Link>
              </div>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modalContent}>
            ...
            <Link
              ...
              className={styles.linkButton}
            >
              <button className={styles.closeButton} tabIndex={0}>
                Close
              </button>
            </Link>
          </div>
